////
////  TextView_Validation.m
////  Runmileapp
////
////  Created by Tecksky Techonologies on 10/26/16.
////  Copyright © 2016 Tecksky Techonologies. All rights reserved.
////
//
//#import "TextView_Validation.h"
//
//
...
//    if(validateOnResign)
//        [(TextView_Validation *)textField validate];
//}
//
//- (BOOL)textView:(UITextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text
//{
//    [(TextView_Validation *)textView dismissPopup];
//    if(validateOnCharacterChanged)
//        [(TextView_Validation *)textView performSelector:@selector(validate) withObject:nil afterDelay:0.1];
//    else
//        [(TextView_Validation *)textView set:nil];
//    if([delegate respondsToSelector:@selector(textView:shouldChangeCharactersInRange:replacementText:)])
...
////    [(TextView_Validation *)textField dismissPopup];
////    if(validateOnCharacterChanged)
////        [(TextView_Validation *)textField performSelector:@selector(validate) withObject:nil afterDelay:0.1];
////    else
////        [(TextView_Validation *)textField set:nil];
...
//@end
//
//@implementation TextView_Validation
...
//}
//
//-(void)addConfirmValidationTo:(TextView_Validation *)txtConfirm withMsg:(NSString *)msg{
...
//            TextView_Validation *txtConfirm=[dic objectForKey:@"confirm"];
