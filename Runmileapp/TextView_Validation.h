...
NS_CLASS_AVAILABLE_IOS(6_0) @interface TextView_Validation : UITextView<UITextViewDelegate>{
 ...
 */
-(void)addConfirmValidationTo:(TextView_Validation *)txtPassword withMsg:(NSString *)msg;
