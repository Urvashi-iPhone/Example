//
//  VehicleInquiry_ViewController.m
//  Runmileapp
//
...
@interface VehicleInquiry_ViewController ()
...
@implementation VehicleInquiry_ViewController
...
- (void)viewDidLoad
{
    ...
    _inquirybtn.layer.cornerRadius = 17.0;
    _closebtn.layer.cornerRadius = 17.0;
...
- (IBAction)inquirybtn:(id)sender
{
    ...
    if([_InquiryName validate] & [_InquiryEmail validate] & [_InquiryTitle validate] & [_inqDescriptionTxt validate] & [_InquiryPhone validate])
    {
        ...
        [setdic setObject:_vehicleid forKey:@"vehicle_id"];
        ...
        [manager POST:[baseurl stringByAppendingString:VehicleInquiry] parameters:setdic progress:nil success:^(NSURLSessionTask *task, id dic12)
